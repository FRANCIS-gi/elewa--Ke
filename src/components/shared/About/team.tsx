  ...
  return (
    <div>
        <div>
            <div>
                <div>
                    {/* Display an image and information for Jente Rosseel */}
                    <img className="about-icons" alt="Globe" src={jenteElewaWbqyyi} />
                    <p className="about-h">Jente Rosseel </p>
                    <p className="about-p">Founder, Managing Partner</p>
                    <a href="https://www.linkedin.com/in/jrosseel/" target="_blank" rel="noopener noreferrer">
                        <img className="img" alt="LinkedIn" src={Linkedin} />
                    </a>                        
                </div>
                <div>
                    {/* Display an image and information for Kennedy Adhola */}
                    <img className="about-icons" alt="Globe" src={kenElewaYdwzop} />
                    <p className="about-h">Kennedy Adhola </p>
                    <p className="about-p">Operations & Partnerships</p>
                    <a href="https://www.linkedin.com/in/kennedy-adhola-97570535/" target="_blank" rel="noopener noreferrer">
                        <img className="img" alt="LinkedIn" src={Linkedin} />
                    </a>                        
                </div>
                <div>
                    {/* Display an image and information for Peter Reinartz */}
                    <img className="about-icons" alt="Globe" src={peterElewaZuzovx} />
                    <p className="about-h">Peter Reinartz </p>
                    <p className="about-p">Executive Chairman</p>
                    <a href="https://www.linkedin.com/in/peter-reinartz-1b4452ab/" target="_blank" rel="noopener noreferrer">
                    <img className="img" alt="LinkedIn" src={Linkedin} />
                    </a>
                </div>
            </div>
            <div>
                <div>
                    {/* Display an image and information for Noella Mwanzia */}
                    <img className="about-icons" alt="Globe" src={noellaElewaG6tquq} />
                    <p className="about-h">Noella Mwanzia</p>
                    <p className="about-p">Software Engineer</p>
                    <a href="https://www.linkedin.com/in/noella-mwanzia-633803173/" target="_blank" rel="noopener noreferrer">
                    <img className="img" alt="LinkedIn" src={Linkedin} />
                    </a>
                </div>
               ...
               {/* This is a profile card for Ian Odhiambo */}
                ...
                <div>
                    ...
                    <p className="about-p">Software Developer</p>
                    <a href="https://www.linkedin.com/in/joy-wawira/" target="_blank" rel="noopener noreferrer">
                        <img className="img" alt="LinkedIn" src={Linkedin} />
                    </a>                        
                </div>
                ...
                <div>
                    ...
                    <p className="about-p">Software Developer</p>
                    <a href="https://www.linkedin.com/in/lynn-nyangon/" target="_blank" rel="noopener noreferrer">
                        <img className="img" alt="LinkedIn" src={Linkedin} />
                    </a>                        
                </div>
                ...
                <div>
                    ...
                    <p className="about-p">Software Engineer </p>
                    <a href=" https://www.linkedin.com/in/reagan-charana/" target="_blank" rel="noopener noreferrer">
                        <img className="img" alt="LinkedIn" src={Linkedin}/>
                    </a>                        
                </div>
                ...
                <div>
                    ...
                    <p className="about-p">Software Engineer </p>
                    <a href="https://www.linkedin.com/in/jeffrey-king-ori-165333164/" target="_blank" rel="noopener noreferrer">
                        <img className="img" alt="LinkedIn" src={Linkedin}/>
                    </a>                        
                </div>
